                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="right text-sm-right text-center">
                                @guest
                                    <a href="{{ route('user.login') }}"><i class="las la-sign-in-alt"></i>
                                        @lang('Login')</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            @else
                                <ul class="navbar-nav main-menu ml-auto">
                                    ...
                                    <li class="menu_has_children"><a href="#0">@lang('Post')</a>
                                        <ul class="sub-menu">
                                            <li><a href="{{ route('user.post.index') }}">@lang('Post All')</a></li>
                                            <li><a href="{{ route('user.post.create') }}">@lang('Create a New Post')</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-6 text-md-left text-center">
                                <p class="copyright font-alt">Copyright &copy; {{ date('Y') }}&nbsp;<a
                                        href="{{ route('home') }}">{{ $general->sitename }}</a>, All Rights Reserved
                                </p>
                            </div>
