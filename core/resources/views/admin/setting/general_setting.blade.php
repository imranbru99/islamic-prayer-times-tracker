                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Site Email') </label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Site Phone') </label>
                        ...
                        <div class="row">
                            <label class="form-control-label font-weight-bold">@lang('Site Info') </label>
                            <input class="form-control" type="text" name="siteinfo" value="{{ $general->siteinfo }}">
                        </div>
                        <div class="row">
                            <div class="form-group col-md-3">
