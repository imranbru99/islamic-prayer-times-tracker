           ...
           <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="Active" data-off="Banned" data-width="100%" name="status" @if($category->status) checked @endif >
                    </div>
                </div>
           </div>
           <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        <textarea name="description" id="" cols="5" rows="10" class="">{{ $category->description }}</textarea>
                    </div>
                </div>
                <div class="col-6">
