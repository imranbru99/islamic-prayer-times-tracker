...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        //Category
        Route::get('category/create', 'CategoryController@create')->name('post.category.create');
        Route::get('category', 'CategoryController@index')->name('post.category.index');
        Route::post('/category/store', 'CategoryController@store')->name('post.category.store');
        Route::get('category/update/{id}', 'CategoryController@edit')->name('post.category.edit');
        Route::post('/category/{id}', 'CategoryController@update')->name('post.category.update');

        //Sub Category
        Route::get('sub-category/create', 'SubCategoryController@create')->name('post.subCategory.create');
        Route::get('sub-category', 'SubCategoryController@index')->name('post.subCategory.index');
        Route::post('/sub-category/store', 'SubCategoryController@store')->name('post.subCategory.store');
        Route::get('sub-category/update/{id}', 'SubCategoryController@edit')->name('post.subCategory.edit');
        Route::post('/sub-category/{id}', 'SubCategoryController@update')->name('post.subCategory.update');
        ...
        Route::get('post/update/{id}', 'PostController@edit')->name('post.edit');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::post('/attendance/toggle', 'AttendanceController@toggle')->name('attendance.toggle');
...
Route::get('/prayer-times', 'PrayerController@times')->name('prayer.times');
Route::get('/qibla', 'PrayerController@qibla')->name('prayer.qibla');
Route::get('/tasbih', 'PrayerController@tasbih')->name('prayer.tasbih');
Route::get('/duas', 'PrayerController@duas')->name('prayer.duas');
Route::get('/names', 'PrayerController@names')->name('prayer.names');
Route::get('/hijri', 'PrayerController@hijri')->name('prayer.hijri');
Route::get('/tracker', 'AttendanceController@index')->name('prayer.tracker');
...
Route::get('page', 'SiteController@pages')->name('pages');
Route::get('/page/{slug}', 'SiteController@pageView')->name('pageView');
Route::get('/tag/{slug}', 'SiteController@tag')->name('tags.show');
Route::get('/category/{slug}', 'SiteController@category')->name('category.show');
Route::get('/author/{username}', 'SiteController@author')->name('author.show');
Route::get('/subCategory/{slug}', 'SiteController@subCategory')->name('subCategory.show');
Route::get('post', 'SiteController@posts')->name('posts');
Route::get('blog', 'SiteController@posts')->name('blog');
Route::get('/{slug}', 'SiteController@postView')->name('postView');

Route::post('/comment', 'SiteController@comment')->name('comment');
